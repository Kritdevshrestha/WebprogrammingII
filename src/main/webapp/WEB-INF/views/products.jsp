...
<head>
    ...
    <title>Afnan Perfumes - Products</title>
...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <h1 class="text-4xl font-bold text-royal-purple mb-8 text-center">Our Perfume Collection</h1>
    <div class="row justify-content-center gx-4 gy-4">
        ...
        <div class="col-8 col-md-4 mb-4">
            <div class="card product-card">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="<c:url value='/9am' />" class="btn w-100 mb-2" style="background-color:#a564c6; color:white; border-radius:25px; font-weight:600; padding:8px 15px; text-decoration:none;">View More</a>
                    <a href="<c:url value='/cart' />" class="btn w-100" style="background-color:#a564c6; color:white; border-radius:25px; font-weight:600; padding:8px 15px; text-decoration:none;">Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-8 col-md-4 mb-4">
            <div class="card product-card">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="<c:url value='/9amblue' />" class="btn w-100 mb-2" style="background-color:#a564c6; color:white; border-radius:25px; font-weight:600; padding:8px 15px; text-decoration:none;">View More</a>
                    <a href="<c:url value='/cart' />" class="btn w-100" style="background-color:#a564c6; color:white; border-radius:25px; font-weight:600; padding:8px 15px; text-decoration:none;">Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-8 col-md-4 mb-4">
            <div class="card product-card">
                <img src="<c:url value='/resources/images/9amred.png' />" class="card-img-top" alt="Afnan 9AM Pour Femme" />
                <div class="card-body text-center">
                    <h5 class="card-title">Afnan 9AM Pour Femme EDP 100ML</h5>
                    <p class="price">Rs 6500</p>
                    <a href="<c:url value='/9amred' />" class="btn w-100 mb-2" style="background-color:#a564c6; color:white; border-radius:25px; font-weight:600; padding:8px 15px; text-decoration:none;">View More</a>
                    <a href="<c:url value='/cart' />" class="btn w-100" style="background-color:#a564c6; color:white; border-radius:25px; font-weight:600; padding:8px 15px; text-decoration:none;">Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-8 col-md-4 mb-4">
            <div class="card product-card">
                <img src="<c:url value='/resources/images/9pmblack.png' />" class="card-img-top" alt="Afnan 9PM" />
                <div class="card-body text-center">
                    <h5 class="card-title">Afnan 9PM Edp De Parfum 100ML</h5>
                    <p class="price">Rs 5000</p>
                    <a href="<c:url value='/9pmblack' />" class="btn w-100 mb-2" style="background-color:#a564c6; color:white; border-radius:25px; font-weight:600; padding:8px 15px; text-decoration:none;">View More</a>
                    <a href="<c:url value='/cart' />" class="btn w-100" style="background-color:#a564c6; color:white; border-radius:25px; font-weight:600; padding:8px 15px; text-decoration:none;">Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-8 col-md-4 mb-4">
            <div class="card product-card">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="price">Rs 6500</p>
                    <a href="<c:url value='/9pmpurple' />" class="btn w-100 mb-2" style="background-color:#a564c6; color:white; border-radius:25px; font-weight:600; padding:8px 15px; text-decoration:none;">View More</a>
                    <a href="<c:url value='/cart' />" class="btn w-100" style="background-color:#a564c6; color:white; border-radius:25px; font-weight:600; padding:8px 15px; text-decoration:none;">Add to Cart</a>
                </div>
            </div>
        </div>
